<div class="flex-column d-none d-lg-flex position-fixed shadow bg-gradient" id="wrapper">
    <ul class="nav flex-column text-center mb-auto">
        ...
        <li class="nav-item my-1">
            <a href="" class="btn btn-primary transparent w-100 px-0"><i class="bi bi-archive fs-2"></i><br>Artigos</a>
        </li>
        ...
        <li class="nav-item my-1">    
          ...
          <?php
            if(isset($self_user)){
          ?>
              <a href= <?="?p=autor&a=$self_username";?> class="btn btn-primary transparent w-100 px-0">
